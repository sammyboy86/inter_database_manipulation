...
mongoexport --db=shapi --collection=superheroes --type=csv --out superheroes_n4j.csv --fields=name,slug,
appearance.gender,appearance.race,biography.publisher,biography.placeOfBirth,biography.alignment,work.base,connections.groupAffiliation, connections.relatives
